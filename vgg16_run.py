...
def vgg_std16_model(img_rows, img_cols, color_type=1):
    model = Sequential()
    model.add(Conv2D(64, (3, 3), padding='same', activation="relu", data_format="channels_first", input_shape=(color_type, img_rows, img_cols)))
    model.add(Conv2D(64, (3, 3), padding='same', activation='relu', data_format="channels_first"))
    model.add(MaxPooling2D((2, 2), strides=(2, 2), data_format="channels_first"))

    model.add(Conv2D(128, (3, 3), padding='same', activation='relu', data_format="channels_first"))
    model.add(Conv2D(128, (3, 3), padding='same', activation='relu', data_format="channels_first"))
    model.add(MaxPooling2D((2, 2), strides=(2, 2), data_format="channels_first"))

    model.add(Conv2D(256, (3, 3), padding='same', activation='relu', data_format="channels_first"))
    model.add(Conv2D(256, (3, 3), padding='same', activation='relu', data_format="channels_first"))
    model.add(Conv2D(256, (3, 3), padding='same', activation='relu', data_format="channels_first"))
    model.add(MaxPooling2D((2, 2), strides=(2, 2), data_format="channels_first"))

    model.add(Conv2D(512, (3, 3), padding='same', activation='relu', data_format="channels_first"))
    model.add(Conv2D(512, (3, 3), padding='same', activation='relu', data_format="channels_first"))
    model.add(Conv2D(512, (3, 3), padding='same', activation='relu', data_format="channels_first"))
    model.add(MaxPooling2D((2, 2), strides=(2, 2), data_format="channels_first"))
    ...
    model.load_weights('../input/vgg16_weights_th_dim_ordering_th_kernels.h5')
